...
const MAX_ZIP_ENTRIES = Number(process.env.SLIDEROOM_MAX_PPTX_ZIP_ENTRIES ?? "2500");
const MAX_UNCOMPRESSED_BYTES = Number(process.env.SLIDEROOM_MAX_PPTX_UNCOMPRESSED_BYTES ?? 750 * 1024 * 1024);
const MAX_XML_PART_BYTES = Number(process.env.SLIDEROOM_MAX_PPTX_XML_PART_BYTES ?? 25 * 1024 * 1024);
const MAX_SINGLE_ENTRY_BYTES = Number(process.env.SLIDEROOM_MAX_PPTX_ENTRY_BYTES ?? 300 * 1024 * 1024);
